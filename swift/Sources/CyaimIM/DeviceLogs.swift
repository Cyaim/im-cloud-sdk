...
actor ImDeviceLogs {
    ...
    @discardableResult
    private func tell(_ answer: DeviceLogAnswer) async -> Bool {
        do {
            ...
            // already — but a row nobody was told about expires saying nothing arrived, and a log
            // sitting in a bucket that the record denies exists is the same as no log at all.
